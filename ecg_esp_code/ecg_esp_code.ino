...
#define WIFISSID "debarghya" // Enter WifiSSID here
#define PASSWORD "debarghya2006" // Enter password here
#define TOKEN "Z35wFDPMmUsXGZUi4MbVsMYtA940sLLL" // Ubidots' TOKEN
#define MQTT_CLIENT_NAME "happypill" // MQTT client Name
// * Define Constants
#define VARIABLE_LABEL "ecg_sensor" // ubidots variable label
